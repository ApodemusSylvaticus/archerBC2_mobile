...
import { ArrowSVGProps } from '@/interface/svg/arrowSvg';

export const ArrowSVG: React.FC<ArrowSVGProps> = ({ size, fillColor, onPress, orientation }) => {
    ...
    return (
        <Pressable onPress={onPress} style={{ transform: `rotate(${transformParam})` }}>
            <Svg width={size} height={size} viewBox="0 0 259 262" fill="none" xmlns="http://www.w3.org/2000/svg">
                <Path
