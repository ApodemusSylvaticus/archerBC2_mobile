...
export const TemperatureSVG: React.FC<BaseSVGProps> = ({ width, height, fillColor }) => {
    return (
        <Svg
            fill={fillColor}
            id="Layer_1"
            ...
            <G>
                <Path
                    d="M45.531,38.322V12.5c0-5.238-4.262-9.5-9.5-9.5c-5.238,0-9.5,4.262-9.5,9.5v25.73c-3,2.719-7.342,7.607-7.342,13.936
		...
		c5.141,2.674,6.203,7.406,6.203,10.906C48.797,59.242,43.102,65,36.097,65z"
                />
                <Path
                    d="M46.027,54.896c-0.514-0.199-1.094,0.057-1.293,0.572c-1.354,3.508-4.791,5.865-8.554,5.865c-0.552,0-1,0.447-1,1
		s0.448,1,1,1c4.583,0,8.77-2.871,10.419-7.145C46.798,55.674,46.543,55.094,46.027,54.896z"
                />
                <Path
                    d="M46.346,51.166c-0.552,0-1,0.447-1,1c0,0.258-0.01,0.512-0.029,0.762c-0.045,0.551,0.365,1.033,0.916,1.078
